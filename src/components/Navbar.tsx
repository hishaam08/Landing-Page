...
function Navbar() {
  return (
    ...
    <div className="bg-black sm:before:content-[''] sm:before:h-7 before:w-full before:absolute before:top-[calc(100%)] relative before:bg-[linear-gradient(to_bottom,#000,rgba(0,0,0,0))] before:z-10">
      <div className="px-4">
